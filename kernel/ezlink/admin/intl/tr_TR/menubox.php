<tr>
    <td background="<?php print $GlobalSiteIni->WWWDir; ?>/images/<?php echo $SiteDesign; ?>/menu-t.gif" valign="top">
      <img src="<?php print $GlobalSiteIni->WWWDir; ?>/images/<?php echo $SiteDesign; ?>/1x1.gif" width="15" height="1">
      <img src="<?php print $GlobalSiteIni->WWWDir; ?>/images/<?php echo $SiteDesign; ?>/menu-link.gif" width="120" height="50">
    </td>
</tr>
<tr>
    <td class="repeaty" background="<?php print $GlobalSiteIni->WWWDir; ?>/images/<?php echo $SiteDesign; ?>/menu-m.gif">
...
<tr>
    <td>
      <img src="<?php print $GlobalSiteIni->WWWDir; ?>/images/<?php echo $SiteDesign; ?>/menu-b.gif" width="150" height="40">
    </td>
</tr>