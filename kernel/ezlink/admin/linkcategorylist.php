<?php
//
// $Id: linkcategorylist.php 7341 2001-09-19 11:35:52Z bf $
//
...
$languageIni = new eZINI( "kernel/ezlink/admin/intl/" . $Language . "/linkcategorylist.php.ini", false );
...
"kernel/ezlink/admin/intl/", $Language, "linkcategorylist.php" );
$t->setAllStrings();
