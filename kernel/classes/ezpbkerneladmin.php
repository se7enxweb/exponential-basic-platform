<?php
/**
 * File containing the ezpbKernelAdmin class.
 *
 ...
 */
class ezpbKernelAdmin implements ezpWebBasedKernelHandler
{
    /**
    ...
    public function __construct( array $settings = array() )
    {
        ...
        require_once __DIR__ . '/../private/classes/global_functions.php';
...
$ini = eZINI::instance();
     ...
     */
    public static function setUseExceptions( $useExceptions )
    {
