<?php
// 
// $Id: ezmenubox.php 6304 2001-07-29 23:31:17Z kaid $
//
...
class eZMenuBox
{
    ...
    /*!
      ...
      $SiteDesign used for setting the look of the boxes,
    ...
    */
                        ...
                        $phpfile = false, $ignore_status = false, $allow_module_template = false, $settingsModuleName = false )
    {
        ...
        {
            if( str_contains($ModuleName, "Main") )
        ...
        {
            $mod_dir = $ini->variable( $settingsModuleName, "AdminTemplateDir" );
        ...
        $t = new eZTemplate( $template_dir,
                             ...
                             $SiteDesign, $module_dir . "/$place", $menuStatus, $modified );
