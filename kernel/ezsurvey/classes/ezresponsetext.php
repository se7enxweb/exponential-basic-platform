<?php
    ...
    Class eZResponseText
    {
        ...
        function getAll( $OrderBy = "ID", $ResponseID = "", $QuestionID = "", $LimitStart = "None", $LimitBy = "None" )
        {
            ...
            {
                $return_array[] = new eZResponseText( $responseItem[ $db->fieldName( "A" ) ] );
            }
            return $return_array;
        }
        ...
        function store()
        {
            ...
            {
                // create
                $db->lock( "eZSurvey_ResponseText" );
                $this->ID = $db->nextID( "eZSurvey_ResponseText", "ID" );
                $res[] = $db->query( "INSERT INTO eZSurvey_ResponseText
            ...
            else
            {
                // update
                $db->lock( "eZSurvey_ResponseText" );
                $res[] = $db->query( "UPDATE eZSurvey_ResponseText set
                                      ID = '$this->ID',
        ...
        function delete()
        {
            ...
            $res[] = $db->query( "DELETE FROM eZSurvey_ResponseText WHERE ID='$this->ID'" );
        ...
        function deleteResponse( $ResponseID, $QuestionID )
        {
            ...
            $res[] = $db->query( "DELETE FROM eZSurvey_ResponseText WHERE ResponseID = '$ResponseID' AND QuestionID = '$QuestionID'" );
        ...
        function deleteByQuestion( $QuestionID )
        {
            ...
            $res[] = $db->query( "DELETE FROM eZSurvey_ResponseText WHERE QuestionID = '$QuestionID'" );
