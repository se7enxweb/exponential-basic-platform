<?php
//
// $Id: datasupplier.php 6212 2001-07-19 12:48:35Z jakobn $
//
...
switch ( $url_array[2] )
{
    case "page":
    {
        include( "kernel/ezexample/admin/page.php" );
    }
    break;
   
    case "page2":
    {
        include( "kernel/ezexample/admin/page2.php" );
    }
    break;

    case "page3":
    {
        include( "kernel/ezexample/admin/page3.php" );
    }
    break;
    
    case "page4":
    {
        include( "kernel/ezexample/admin/page4.php" );
    }
    break;
