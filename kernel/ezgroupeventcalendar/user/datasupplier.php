...
$eventArrayID       = $_POST['eventArrayID'] ?? [];
...
$Start_Hour         = eZHTTPTool::getVar( 'Start_Hour' );
$Start_Minute       = eZHTTPTool::getVar( 'Start_Minute' );
$Start_AM_PM        = eZHTTPTool::getVar( 'Start_AM_PM' );
...
$Stop_Hour          = eZHTTPTool::getVar( 'Stop_Hour' );
$Stop_Minute        = eZHTTPTool::getVar( 'Stop_Minute' );
$Stop_AM_PM         = eZHTTPTool::getVar( 'Stop_AM_PM' );
...
$dateCal            = eZHTTPTool::getVar( 'dateCal' );
