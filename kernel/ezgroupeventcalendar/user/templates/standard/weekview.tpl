...
<div id="gcalDayViewSortBy">
 <div id="gcalDayViewSortByHeader"><img src="{www_dir}{index}/kernel/ezgroupeventcalendar/user/templates/standard/images/gcalX.png" style="margin-right:7px;" alt="close" onclick="document.getElementById('gcalDayViewSortBy').style.visibility = 'hidden';" />
 </div>
...
<div class="gcalWeekDayHeaders">
<!-- BEGIN week_day_tpl -->
<div class="gcalWeekDayHeader" style="background: url('{www_dir}{index}/kernel/ezgroupeventcalendar/user/templates/standard/images/gcalMonthViewHeaderBg.png') repeat;">{week_day_name}</div>
<!-- END week_day_tpl -->
</div>

<div class="gcalWeekRow">

<!-- BEGIN day_tpl -->
<div class="{td_class} gcalWeekDay">
<div class="gcalWeekDayTop">
  <div>
...
<script language="javascript">
  document.querySelectorAll('.gcalWeekDayHeader').forEach(function(el) {
