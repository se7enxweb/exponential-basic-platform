...
$t = new eZTemplate( "eztrade/admin/" . $ini->variable( "eZTradeMain", "AdminTemplateDir" ),
                     "eztrade/admin/intl/", $language, "detailcategorylist.php" );
...
$t->set_file( "category_list_page_tpl", "detailcategorylist.tpl" );
...
//////////////////////////////////////////
// Display Product List Bulk Editor Mode

// Products
$totalTypes = $category->productCount( $category->sortMode(), true, true );
