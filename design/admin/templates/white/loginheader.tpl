...
<tr>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
<tr>
    <td class="repeaty" rowspan="2" width="0%" background="{www_dir}/design/admin/images/{site_style}/box-l02.gif" valign="top"><img src="{www_dir}/design/admin/images/{site_style}/box-l01.gif" width="10" height="10" border="0" /><br /></td>
...
<tr>
    <td class="tdmini" width="1" valign="top" align="left"><img src="{www_dir}/design/admin/images/{site_style}/box-l03.gif" width="10" height="11" border="0" alt="" /><br /></td>
    <td class="repeatx" width="100%" background="{www_dir}/design/admin/images/{site_style}/box-m02.gif" valign="top"><img src="{www_dir}/design/admin/images/{site_style}/1x1.gif" width="120" height="11" border="0" alt="" /><br /></td>
    <td class="tdmini" width="1" valign="top" align="left"><img src="{www_dir}/design/admin/images/{site_style}/box-r03.gif" width="10" height="11" border="0" alt="" /><br /></td>
</tr>
<tr>
