...
<tr>
   <td class="tdmini" width="99%" colspan="2">
     <a class="logo" href="<?php print $GlobalSiteIni->WWWDir; ?>/"><img class="logoImage" src="<?php print $GlobalSiteIni->WWWDir; ?>/design/<?php print ($GlobalSiteDesign); ?>/images/exponential-basic-yourcontentmadeeasy.png" height="20" width="290" border="0" alt="" /></a><br />
   </td>
</tr>
   <tr>
...
<!-- Right menu end -->
   ...
   <div align="center">
   <a target="_blank" href="/about"><img src="<?php print $GlobalSiteIni->WWWDir; ?>/design/base/images/logo/powered-by-ezpublish-100x35-trans-lgrey.gif" width="90" height="35" border="0" alt="Powered by Exponential Basic" /></a>
   </div>
