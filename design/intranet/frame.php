...
<body bgcolor="#669966" topmargin="6" marginheight="6" leftmargin="6" marginwidth="6"
...
<tr>
   ...
   <td class="tdmini" width="99%" colspan="2">
     <!--     <a class="logo" href="<?php print $GlobalSiteIni->WWWDir; ?>/"><img class="logoImage"                                                                                                                                                                                                    
              src="<?php print $GlobalSiteIni->WWWDir; ?>/design/<?php print ($GlobalSiteDesign); ?>/images/exponential-basic-yourcontentmadeeasy.png"                                                                                                                                                         
              height="20" width="290" border="0" alt="" /></a><br />                                                                                                                                                                                                                                   
     </td>                                                                                                                                                                                                                                                                                             
...
<tr>
	...
	<td class="tab" bgcolor="#e2efe2" width="30%">&nbsp;&nbsp;<a href="<?php print $GlobalSiteIni->WWWDir . $GlobalSiteIni->Index; ?>/section-standard/">Standard</a>&nbsp;&nbsp;</td>
	<td class="tdmini" width="0%">
	...
	<td class="tab" bgcolor="#ffffff" width="30%">&nbsp;&nbsp;<a href="<?php print $GlobalSiteIni->WWWDir . $GlobalSiteIni->Index; ?>/section-intranet/">Intranet</a>&nbsp;&nbsp;</td>
	<td class="tdmini" width="0%">
	...
	<td class="tab" bgcolor="#e2efe2" width="30%">&nbsp;&nbsp;<a href="<?php print $GlobalSiteIni->WWWDir . $GlobalSiteIni->Index; ?>/section-trade/">Trade</a>&nbsp;&nbsp;</td>
	<td class="tdmini" width="0%">
	...
	<td class="tab" bgcolor="#e2efe2" width="30%">&nbsp;&nbsp;<a href="<?php print $GlobalSiteIni->WWWDir . $GlobalSiteIni->Index; ?>/section-news/">News</a>&nbsp;&nbsp;</td>
    <td class="tdmini" width="0%">
    <img src="<?php print $GlobalSiteIni->WWWDir; ?>/design/<?php print ($GlobalSiteDesign); ?>/images/tab-unmrk-unmrk.gif" height="20" width="20" border="0" alt="" /><br />
    </td>
