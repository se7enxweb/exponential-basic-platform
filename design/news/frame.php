...
if ( isset( $Title ) )
    ...
    <link rel="stylesheet" type="text/css" href="<?php print $GlobalSiteIni->WWWDir; ?>/design/news/style.css" />
...
<tr>
	...
	<td class="tab" bgcolor="#eee4e4" width="30%">&nbsp;&nbsp;<a href="<?php print $GlobalSiteIni->WWWDir . $GlobalSiteIni->Index; ?>/section-standard/">Standard</a>&nbsp;&nbsp;</td>
	<td class="tdmini" width="0%">
	...
	<td class="tab" bgcolor="#eee4e4" width="30%">&nbsp;&nbsp;<a href="<?php print $GlobalSiteIni->WWWDir . $GlobalSiteIni->Index; ?>/section-intranet/">Intranet</a>&nbsp;&nbsp;</td>
	<td class="tdmini" width="0%">
	<img src="<?php print $GlobalSiteIni->WWWDir; ?>/design/<?php print ($GlobalSiteDesign); ?>/images/tab-unmrk-unmrk.gif" height="20" width="20" border="0" alt="" /><br />
	</td>
	<td class="tab" bgcolor="#eee4e4" width="30%">&nbsp;&nbsp;<a href="<?php print $GlobalSiteIni->WWWDir . $GlobalSiteIni->Index; ?>/section-trade/">Trade</a>&nbsp;&nbsp;</td>
	<td class="tdmini" width="0%">
	...
	<td class="tab" bgcolor="#ffffff" width="30%">&nbsp;&nbsp;<a href="<?php print $GlobalSiteIni->WWWDir . $GlobalSiteIni->Index; ?>/section-news/">News</a>&nbsp;&nbsp;</td>
	<td class="tdmini" width="0%">
...
-->
	...
	<td class="menu-right" width="1%" bgcolor="#fbf7f7">
